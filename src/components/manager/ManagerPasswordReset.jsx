...
const ManagerPasswordReset = () => {
    ...
    const url = `https://sukriti-invoice-server.herokuapp.com/api/manager/verifyPasswordChange`;
    const updatePasswordurl = `https://sukriti-invoice-server.herokuapp.com/api/manager/updatePassword`;

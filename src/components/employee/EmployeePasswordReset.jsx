...
const EmployeePasswordReset = () => {
    ...
    const url = `https://sukriti-invoice-server.herokuapp.com/api/employee/verifyPasswordChange`;
    const updatePasswordurl = `https://sukriti-invoice-server.herokuapp.com/api/employee/updatePassword`;

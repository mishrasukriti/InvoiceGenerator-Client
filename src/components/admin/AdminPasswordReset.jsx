...
const AdminPasswordReset = () => {
    ...
    const url = `https://sukriti-invoice-server.herokuapp.com/api/admin/verifyPasswordChange`;
    const updatePasswordurl = `https://sukriti-invoice-server.herokuapp.com/api/admin/updatePassword`;
